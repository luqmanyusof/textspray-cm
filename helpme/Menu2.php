...
class Menu2 {
    ...
    public function appliStart($mode = 'edit', $curr = 'home', $hide=[]) {
        $menu = [
            ...
            'member'      => ['Lokasi', 'appeal-member/list', 'fa-user'],
            'cost'        => ['Modal', 'appeal-cost/list', 'fa-dollar'], 
            'performance' => ['Prestasi Projek', 'appeal-performance/list', 'fa-bar-chart'],
            'attachment'  => ['Sisipan Dokumen', 'appeal/attachment', 'fa-file-word-o'],
            'confirm'     => ['Pengesahan', 'appeal/confirm', 'fa-check-square-o']
            ];
