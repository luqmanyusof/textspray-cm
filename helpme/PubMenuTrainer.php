...
class PubMenuTrainer {

    public function menutrainerStart($curr = 'home') {
        $menu = [
            'home'         => ['Maklumat Jurulatih','pub/home/profil', ''], 
            'lampiran'  => ['Lampiran', 'pub/home/trainerdoc', ''], 
        ];
           
        //$str  = "<legend><i class='green fa fa-user'></i> Kemaskini Profil </legend>";
    ...
    public function menutrainerEnd() {
        $str = "
                            </div><!-- end tab-pane -->
                        </div><!-- end tab-content -->
                    </div><!-- end tabable -->
